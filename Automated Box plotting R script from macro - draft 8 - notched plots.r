...
SubDirName<-paste("Plots/", sub("~[0-9]*", "", SampleName))
...
par(mar = c(5,6,3,5))
boxplot(XSortedData, log="y", xaxt = "n",  xlab = "", notch = TRUE, ylim = c(min(XSortedData, na.rm = TRUE), max(XSortedData, na.rm = TRUE)), cex.lab=2, cex.axis=2, cex.main=2, cex.sub=2, bty="n")
axis(1, at=seq(0.5, (nBin+0.5), 1), labels=Xbinseq, cex.axis = 2)
par(new=T)
plot(Xpercenttotal, type="o", axes = F, xlab = NA, ylab = NA, pch = 2, cex=2, xlim = c((0.5),(nBin+0.5)), ylim = c(0, round((max(Xpercenttotal)+0.005), 2)), lty=5, lwd=2, bty="n")
axis(4, cex.axis=2)
...
title(main = paste(SampleName, " - X Axis Distribution"), cex.main = 1.8, line = 1.5)
...
par(mar = c(5,6,3,5))
boxplot(YSortedData, log="y", xaxt = "n",  xlab = "", notch = TRUE, ylim = c(min(XSortedData, na.rm = TRUE), max(XSortedData, na.rm = TRUE)), cex.lab=2, cex.axis=2, cex.main=2, cex.sub=2, bty="n")
axis(1, at=seq(0.5, (nBin+0.5), 1), labels=Ybinseq, cex.axis = 2)
par(new=T)
plot(Ypercenttotal, type="o", axes = F, xlab = NA, ylab = NA, pch = 2, cex = 2, xlim = c((0.5),(nBin+0.5)), ylim = c(0, round((max(Ypercenttotal)+0.005), 2)), lty=5, lwd=2, bty="n")
axis(4, cex.axis=2)
mtext(side=1, line = 3, "Y Axis Position (μm)", cex = 2)
mtext(expression(paste( plain("Bundle Volume Distribution (μm") ^ plain("3"), plain(")") )), side=2, line = 3, cex = 2)
mtext(side=4, line = 3, "CNT Volume : Sample Volume", cex = 2)
title(main = paste(SampleName, " - Y Axis Distribution"), cex.main = 1.8, line = 1.5)
...
par(mar = c(5,6,3,5))
boxplot(ZSortedData, log="y", xaxt = "n",  xlab = "", notch = TRUE, ylim = c(min(XSortedData, na.rm = TRUE), max(XSortedData, na.rm = TRUE)), cex.lab=2, cex.axis=2, cex.main=2, cex.sub=2, bty="n")
axis(1, at=seq(0.5, (nBin+0.5), 1), labels=Zbinseq, cex.axis = 2)
par(new=T)
plot(Zpercenttotal, type="o", axes = F, xlab = NA, ylab = NA, pch = 2, cex = 2, xlim = c((0.5),(nBin+0.5)), ylim = c(0, round((max(Zpercenttotal)+0.005), 2)), lty=5, lwd=2, bty="n")
axis(4, cex.axis=2)
mtext(side=1, line = 3, "Z Axis Position (μm)", cex = 2)
mtext(expression(paste( plain("Bundle Volume Distribution (μm") ^ plain("3"), plain(")") )), side=2, line = 3, cex = 2)
mtext(side=4, line = 3, "CNT Volume : Sample Volume", cex = 2)
title(main = paste(SampleName, " - Z Axis Distribution"), cex.main = 1.8, line = 1.5)	
