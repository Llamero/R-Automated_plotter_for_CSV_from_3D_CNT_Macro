...
par(mar = c(5,6,3,5))
boxplot(XSortedData, log="y", xaxt = "n",  xlab = "", notch = FALSE, ylim = c(min(XSortedData, na.rm = TRUE), max(XSortedData, na.rm = TRUE)), cex.lab=2, cex.axis=2, cex.main=2, cex.sub=2, bty="n")
...
par(mar = c(5,6,3,5))
boxplot(YSortedData, log="y", xaxt = "n",  xlab = "", notch = FALSE, ylim = c(min(XSortedData, na.rm = TRUE), max(XSortedData, na.rm = TRUE)), cex.lab=2, cex.axis=2, cex.main=2, cex.sub=2, bty="n")
...
par(mar = c(5,6,3,5))
boxplot(ZSortedData, log="y", xaxt = "n",  xlab = "", notch = FALSE, ylim = c(min(XSortedData, na.rm = TRUE), max(XSortedData, na.rm = TRUE)), cex.lab=2, cex.axis=2, cex.main=2, cex.sub=2, bty="n")
